-- ============================================================
-- ANUGERAH MULIA — Setup database Supabase (jalankan di SQL Editor)
-- Satu berkas: enum, tabel, GRANT, RLS, trigger, dan data awal.
-- Jalankan pada project Supabase BARU/kosong.
-- ============================================================
